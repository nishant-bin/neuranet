export const i18n = {
"Title" : "Neuranet",
"logintagline": "Enterprise Neural Networks",
...
"ErrorConvertingBadInputSQL": "Error in conversion, due to bad input SQL.\n\n{{#message}}.{{/message}}{{^message}}SQL parser failed to parse.{{/message}}\n\nFound at: Line:{{#line}}.{{/line}}{{^line}}0{{/line}}, Column:{{#column}}.{{/column}}{{^column}}0{{/column}}.",
"PossibleErrorConverting": "--- WARNING: Possibly bad SQL.\n--- {{#message}}.{{/message}}{{^message}}SQL parser failed to parse.{{/message}}\n--- Found at: {{#line}}.{{/line}}{{^line}}0{{/line}}, Column:{{#column}}.{{/column}}{{^column}}0{{/column}}.",
